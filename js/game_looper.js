Kraken.gameLoop = function (spec) {
    spec.interval = (typeof spec.interval === 'number') ? spec.interval : 100;
    spec.tick_func = (typeof spec.tick_func === 'function') ? spec.tick_func 
        : function () {};
    ...
    that.start = function () {
        clearInterval(timer);
        timer = setInterval(spec.tick_func, spec.interval);
    };
